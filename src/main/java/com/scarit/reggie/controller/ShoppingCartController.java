...
import com.scarit.reggie.entity.ShoppingCart;
import com.scarit.reggie.service.ShoppingCartService;
...
public class ShoppingCartController {
    ...
    public R<ShoppingCart> sub(@RequestBody ShoppingCart shoppingCart){
        ...
        if(dishId != null){
            ...
            //前端问题，减少购物车会减到负数
            Integer resNum = cart1.getNumber();
            if(resNum > 0){
                //更新
                shoppingCart.updateById(cart1);
            } else if(resNum == 0){
